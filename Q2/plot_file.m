...
hold off;
title('True and Predicted x[m] vs t[s]','Interpreter','latex');
grid;
u = legend([p q r s ],'$x_{true}$','$x_{pred}$', '$e_{x}$', '$\pm3\sigma$');
...
hold off;
title('True and Predicted y[m] vs t[s]','Interpreter','latex');
grid;
u = legend([p q r s ],'$y_{true}$','$y_{pred}$', '$e_{y}$', '$\pm3\sigma$');
set(u,'Interpreter','latex');
% xlabel('t[s]','Interpreter','latex')
...
hold off;
title('True and Predicted $\theta$[rad] vs t[s]','Interpreter','latex');
grid;
u = legend([p q r s ],'$\theta_{true}$','$\theta_{pred}$', '$e_{\theta}$', '$\pm3\sigma$');
set(u,'Interpreter','latex');
% xlabel('t[s]','Interpreter','latex')
...
title(' $\Sigma_{xx}$, $\Sigma_{yy}$, $\Sigma_{\theta \theta}$ vs t[s]','Interpreter','latex');
grid;
hold off;
